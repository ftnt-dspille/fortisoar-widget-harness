  ...
  const checkDeps = (file) => {
    ...
    if (unknown.length > 0) {
      errors.push({
        ...
        file,
        message: `${file} injects services not registered anywhere: ${unknown.join(", ")}. Add a stub to harness.module.js, or ship a widgetAssets file that registers it and <script>-tag it from view.html/edit.html.`,
        unknown,
      });
    }
  };
